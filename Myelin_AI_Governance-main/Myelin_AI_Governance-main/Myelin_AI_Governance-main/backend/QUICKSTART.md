...
```bash
# 1. Open Firebase Console and your project
# 2. Enable Firestore Database
# 3. Generate a service account JSON from Project settings → Service accounts
# 4. Keep that JSON on your local machine
```
