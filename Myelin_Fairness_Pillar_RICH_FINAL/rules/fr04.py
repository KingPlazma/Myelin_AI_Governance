...
RULE_ID = "FR04"
RULE_NAME = "Equalized Odds Difference"
...
def evaluate(ctx):
    ...
    raw = 0.5 * (abs(m0['tpr'] - m1['tpr']) + abs(m0['fpr'] - m1['fpr']))
    val0 = m0['tpr'] + m0['fpr']; val1 = m1['tpr'] + m1['fpr']
    explanation = f'Average difference in TPR and FPR between groups'
