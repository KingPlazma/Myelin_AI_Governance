...
chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
  // Only process messages from this extension itself (popups / content scripts).
  // Reject any message that doesn't have a proper extension sender.
  if (sender.url && !sender.url.startsWith(chrome.runtime.getURL(''))) {
    // Message came from a web page — reject silently
    return false;
  }
